...
class ChartbrController extends Controller {
	...
	public static function location() {
		...
		// $loc = \DB::select(" SELECT Count(address) FROM store_records WHERE DATE(time_in) = CURDATE() AND StoreID = $user Group by address Limit 1");
	...
	public function index() {
		...
		return view('homepage_bm', compact('profchart'))->with('gender', json_encode($array));
