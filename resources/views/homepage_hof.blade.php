        ...
        <div id="content">
            <div class="card" style="padding-right: 32px; padding-left:32px;">
                ...
                <div class="row">
                    ...
                    <a href="homepage_hof"class="btn btn-md btn-block shadow-sm p-3 mb-4 rounded"><i class="fa fa-folder"></i>Store Account Settings</a>
                    <a href="hofaddexpenses" class="btn btn-md btn-block shadow-sm p-3 mb-4 rounded"><i class="fa fa-folder"></i>Store Password and Security</a>
                    <a href="sp_password" class="btn btn-md btn-block shadow-sm p-3 mb-4 rounded"><i class="fa fa-folder"></i>Store Personnel Password and Security</a>
                    </div>
                    <div class="col py-4">
                        <div class="card border-dark mb-3 text-center">
                            <div class="row">
                                <div class="col-sm-3" style="padding-top: 10px; margin-left:50px;"></div>
                                    <!--<center><img src="" class="img-thumbnail rounded-circle border-0 mx-auto d-block"></center>-->
                                    <!-- <center><img src="/public/img/{{ $user->Image }}" style="width:150px; height:150px; float:right; border-radius:50%;"> </center> -->
                                    <center>
                                        <img id="output" style="width:150px; height:150px; float:right; border-radius:50%;"/>
                                    </center>
                                <div class="col-sm-6" style="margin-left:50px;">
                                    <form enctype="multipart/form-data" action="/homepage_hof" method="POST">
                                    <label>Update Profile Image</label>
                                    <!--<input type="file" class="form-control" id="customFile"/>
                                    <br>
                                    <button class="btn bg-primary text-white  btn-sm btn-block shadow-sm p-3 mb-4 rounded"><i class="fa fa-folder"></i> Update Picture</button>-->                                    
                ...
                <br>
                <div class="card" style="padding-right: 32px; padding-left:32px; padding-top:32px;">
                <div class="row">
                ...
                <form method="POST"  action="{{ route('homepage_hof.update') }}" style="padding-left:20px;">
                    <!-- may dinelete muna ako dito sa taas ^ nito na action="route('homepage_hof.update')" para lang mag run hanggang settings-->
                    @csrf
                    @if(session('success'))
                    ...
                    <div class="form-row">
                        <!-- <br> -->
                        <div class="form-group col-md">
                            <button class="btn bg-primary text-white btn-md btn-block shadow-sm p-3 mb-4 rounded"><i class="fa fa-folder"></i> Update Information</button>
                        </div>
                    </div>
                </form>
            </div>
