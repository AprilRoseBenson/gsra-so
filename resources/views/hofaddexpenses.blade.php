...
<div id="content">
   ...
   <form method="POST" action="{{ route('hofaddexpenses.update') }}" style="padding-left:20px;">
...
@endif
   ...
   control @error('oldpass') is invalid @enderror" style="width:100%;"
    id="" name="conpass">
    </div>
    </div>
    <div class="form-row">
    <div class="form-group col-md">
   <label for="formGrooupExampleInput">EmailAddress</label><br>
    <input type="text" class="form-
   control @error('email') is invalid @enderror" style="width:100%;"
    id="email" name="email" value="{{ $user['
   email'] }}">
    </div>
    </div>
    <div class="form-row">
   ...
   control @error('newpass') is invalid @enderror" style="width:100%;"
    ...
    <div class="form-row">
    <div class="form-group col-md">
    <label for="formGrooupExampleInput">Re-
   type Password</label><br>
    <input type="password" class="form-
   control @error('conpass') is invalid @enderror" style="width:100%;"
    id="" name="conpass">
    </div>
    </div>
   <br>
   ...
   folder"></i> Update Password</button>
    </div>
    </div>
    </form>
    </div>
